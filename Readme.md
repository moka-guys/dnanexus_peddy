...
Version 2.3 of this app was designed specifically for use with DNAnexus London AWS servers (EU-West-2).
...
- The VCF naming convention may be hyphen (-) or underscore (_) separated. 
- More than one vcf with the extension '.refined.vcf.gz' or 'aplotyper.vcf.gz' is required.
- The filename of each sample must include the gender as 'M' or 'F' deliminated by underscores or hyphens.
